...
class $NotesTable extends Notes with TableInfo<$NotesTable, Note> {
  ...
  @override
  late final GeneratedColumn<bool> updatedAt = GeneratedColumn<bool>(
      'updated_at', aliasedName, true,
      type: DriftSqlType.bool,
      requiredDuringInsert: false,
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('CHECK ("updated_at" IN (0, 1))'));
  @override
  ...
  Note map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Note(
      ...
      updatedAt: attachedDatabase.typeMapping
          .read(DriftSqlType.bool, data['${effectivePrefix}updated_at']),
    );
  }
...
class Note extends DataClass implements Insertable<Note> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || updatedAt != null) {
      map['updated_at'] = Variable<bool>(updatedAt);
    }
    return map;
  }
  ...
  factory Note.fromJson(Map<String, dynamic> json,
    ...
    return Note(
      ...
      updatedAt: serializer.fromJson<bool?>(json['updatedAt']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'updatedAt': serializer.toJson<bool?>(updatedAt),
    };
  }
  ...
  Note copyWith(
          ...
          String? content,
          DateTime? createdAt,
          Value<bool?> updatedAt = const Value.absent()}) =>
      Note(
        id: id ?? this.id,
...
class NotesCompanion extends UpdateCompanion<Note> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (updatedAt.present) {
      map['updated_at'] = Variable<bool>(updatedAt.value);
    }
    return map;
  }
...
class $$NotesTableFilterComposer extends Composer<_$NoteDatabase, $NotesTable> {
  ...
  ColumnFilters<bool> get updatedAt => $composableBuilder(
...
class $$NotesTableOrderingComposer
  ...
  ColumnOrderings<bool> get updatedAt => $composableBuilder(
...
class $$NotesTableAnnotationComposer
  ...
  GeneratedColumn<bool> get updatedAt =>
