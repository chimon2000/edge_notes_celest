...
import 'package:celest_core/src/exception/serialization_exception.dart'
    as _$celest;
import 'package:edge_notes_api_client/edge_notes_api_client.dart';

class CelestFunctions {
  final greeting = CelestFunctionsGreeting();

  final notes = CelestFunctionsNotes();
}
...
class CelestFunctionsGreeting {
  Never _throwError({
    ...
    switch (errorType) {
      case 'edge_notes_api.v1.BadNameException':
